...
import { Text, View, ScrollView, StatusBar, TextInput, Pressable } from 'react-native';
...
export default function App() {
  ...
  return (
    <ScrollView>
      ...
      <Janela>
        <Text style={{fontSize:8, marginBottom:16, textAlign:"center"}}>Historico de Gastos</Text>
